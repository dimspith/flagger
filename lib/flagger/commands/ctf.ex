defmodule Flagger.Commands.CTF do
  @moduledoc false
  ...
  def usage,
    do: [
      "ctf create <ctftime_link | event_id>",
      "ctf delete <ctftime_link | event_id>"
    ]
  ...
  def command(msg, ["create", link | _rest]) do
    ...
    {:ok, category} = Api.create_guild_channel(msg.guild_id, type: 4, name: "#{event_info["title"]} (#{event_info["id"]})")
